...
const CERTIFICATES: Record<string, {
  ...
  "OS-EXP-2026-003": {
    ...
    credentialType:  "Full-Time",
    department:      "Web Developer",
    joiningDate:     "01 October 2025",
    releaseDate:     "30 April 2026",
    organization:    "OceaniaSoft Ltd.",
    employeeId:      "OS-77291",
    authorizedBy:    "Rabbani Rafi",
    authorizerRole:  "Chief Executive Officer",
    certifiedOn:     "07 May 2026",
    description:     "Mr. Reham was a key member of our development team. During his tenure, he worked on various web development projects and made valuable contributions. His key responsibilities included:",
    responsibilities: [
      "Developing and maintaining responsive, modern web applications using HTML5, CSS3, and JavaScript (ES6+).",
      "Implementing front-end frameworks and libraries (e.g., React or Vue.js) to build interactive and user-friendly components.",
      "Writing clean, maintainable, and well-documented code following industry best practices.",
      "Optimizing web applications for performance, accessibility, and cross-browser compatibility.",
      "Collaborating with the backend team to implement secure API integrations and ensure data sanitization to prevent common web vulnerabilities.",
      "Maintaining project documentation, deploying updates to staging and production environments, and assisting with release coordination and rollback procedures.",
    ],
